...
export const Footer = () => {
  return (
    <footer className="w-full h-full pt-16 pb-11 bg-custom-black text-custom-white text-shadow-custom-white">
      <div className="flex justify-between w-full px-14">
        <ContactForm />
        <div className="flex items-center gap-x-7">
          <div>
            <p className="mb-3 cursor-context-menu text-xl font-bold">사이트</p>
          ...
          <div className="">
            <p className="mb-3 cursor-context-menu font-bold text-xl">소셜</p>
            <ul className="flex flex-col gap-y-1">
      ...
      <div className="flex items-center justify-between w-full px-14">
        <div className="flex gap-x-3 items-center">
          ...
          <Link
            href="https://github.com/hopago/Hopago_Wealth_Manager"
            target="_blank"
          >
        ...
        <div className="flex gap-x-3 items-center">
          <Link href="https://github.com/hopago" target="_blank">
            <GithubIcon className="size-9" />
          </Link>
          <Link
            href="https://rightful-reptile-a6a.notion.site/494462a6b83a4677ad69faf303df42bd?pvs=74"
            target="_blank"
          >
            <svg
