...
import { jsSvg, tsSvg, reactSvg, nextSvg } from "../../../../../../public/svg/icons";
      ...
      <div className="flex-[3_5] flex flex-col gap-7">
        ...
        <div className="flex justify-between gap-5">
          <div className="flex-1 flex flex-col gap-5">
            <span className="font-bold text-2xl text-custom-white">기술 스택</span>
          ...
          <div className="flex-1 flex flex-col gap-7">
            <span className="font-bold text-2xl text-custom-white">프로젝트</span>
            <div className="flex items-center gap-5 flex-wrap">
              <Link href="https://hommerce.co.kr" target="_blank" rel="noopener noreferrer" className="box-shadow-custom-white rounded-[20px]">
                <AnimatedCard
                  title="Hommerce"
